...
import { prezData } from '../routes/Data';

let nameList=[];
prezData.forEach((item,index)=>{
        ...
        <div className='card-container'>
            <div className='card'>
                <>
                  ...
                  <h2>{nameList[6]}</h2>
                  <ul>
                    Student Count: {countList[6]}
                    Exam 1 Date: {exam1List[6]}
                    {/* Exam 2 Date: {exam2List[6]}
                    Exam 3 Date: {exam3List[6]} */}
                  </ul>
                </>
            </div>
        </div>
